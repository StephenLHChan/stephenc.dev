    ...
    <Container>
      ...
      <Section delay={0.2}>
        ...
        <Box>
          ...
          <br />
          <Paragraph>
            I am now looking for a software development job in Toronto, Canada,
            and I am ready to take all the challenges as a software engineer.
          </Paragraph>
        </Box>
      </Section>
      ...
      <Section delay={0.4}>
        ...
        {bioItems.map(({ id, year, children }) => {
          return <BioItem key={id} year={year} content={children} />
        })}
      </Section>
      ...
      <Section delay={0.8}>
        ...
        >
          {socialMediaList.map(({ type, link, icon }) => {
            return <SocialMediaIcon key={type} link={link} icon={icon} />
          })}
        </Flex>
      </Section>
    </Container>
